    ...
    >
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
          ...
          <span style={{
            marginLeft: "auto", fontSize: 9, color: C.muted, padding: "2px 8px",
        ...
        <div className="diagnosis-box" style={{
          ...
          fontSize: expanded ? 13 : 12, lineHeight: expanded ? 1.8 : 1.6,
        }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: expanded ? 4 : 2 }}>
              {traceSteps.map((s, i) => (
                <div key={i} className="signal-step" style={{
                  ...
                  <span style={{ fontSize: expanded ? 12 : 10, width: 16, textAlign: "center" }}>
                  ...
                  {s.detail && (
                    <span className="mono" style={{
                      marginLeft: "auto", fontSize: expanded ? 11 : 10,
      ...
      <div style={{ display: "grid", gridTemplateColumns: remoteFix ? "1fr 1fr" : "1fr", gap: 10 }}>
        <div style={{
          ...
          <div className="operator-action" style={{
            ...
            fontSize: expanded ? 13 : 12, lineHeight: expanded ? 1.7 : 1.5,
          }}>

...
const Device = ({ name, domain, status, detail }) => (
  <div style={{
    ...
    <span style={{ fontSize: 12, color: status === "error" ? C.red : C.text, flex: 1 }}>{name}</span>
    {domain && <DomainTag domain={domain} />}
    {detail && <span className="mono" style={{ fontSize: 11, color: status === "error" ? C.red : C.muted }}>{detail}</span>}
  </div>
);
  ...
  return (
    <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
      <ZoneBox zone="ZONE 1" title="Front Cab — Command Center" color={C.accent} status={isAperaCrash || isRouterFreeze ? "error" : "ok"}>
        <div style={{ fontSize: 11, color: C.muted, textTransform: "uppercase", letterSpacing: 0.6 }}>Compute & Control</div>
        ...
        <div style={{ fontSize: 11, color: C.muted, textTransform: "uppercase", letterSpacing: 0.6, marginTop: 4 }}>Networking</div>
        ...
        <div style={{ fontSize: 11, color: C.muted, textTransform: "uppercase", letterSpacing: 0.6, marginTop: 4 }}>Power & I/O</div>
      ...
      <ZoneBox zone="ZONE 2" title="Middle — Power Generation" color={C.amber} status="ok">
        <div style={{ fontSize: 11, color: C.muted, textTransform: "uppercase", letterSpacing: 0.6 }}>Prime Power</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 11, color: C.muted, marginBottom: 4 }}>POWER OUTPUT</div>
          <div style={{ display: "flex", gap: 12 }}>
            <div>
              <span style={{ fontSize: 11, color: C.cyan }}>120V AC → </span>
              <span style={{ fontSize: 11, color: C.dim }}>Zone 1 IT Stack</span>
            </div>
            <div>
              <span style={{ fontSize: 11, color: C.orange }}>→ Rhino PSR → </span>
              <span style={{ fontSize: 11, color: C.dim }}>24V DC OT</span>
            </div>
          </div>
        </div>
      </ZoneBox>
      ...
      <ZoneBox zone="ZONE 3" title="Rear — Robot & Distribution" color={C.purple} status={isServoFault ? "error" : "ok"}>
        <div style={{ fontSize: 11, color: C.muted, textTransform: "uppercase", letterSpacing: 0.6 }}>Actuation</div>
        ...
        <div style={{ fontSize: 11, color: C.muted, textTransform: "uppercase", letterSpacing: 0.6, marginTop: 4 }}>Control Box</div>
        ...
        <div style={{ fontSize: 11, color: C.muted, textTransform: "uppercase", letterSpacing: 0.6, marginTop: 4 }}>HMI</div>
